...
def MissForestImpute(seriesTensor, masksTensor, numPatients, numTimeSteps, numVars):
    ...
    for i in range(numPatients):
        ...
        transformer = imputerObject.fit(X=series[i])
        #return transformed data
        filledPatientTS = transformer.transform(X=series[i])
    ...
    torch.save(seriesTensor, 'RandomForest_time_series.pt')
    print("Saved!")
